...
void handle_gnss_nmea_command(const char *value)
{
    ...
    {
        strncpy((char *)cat_m1_Status_Rtt_Gps.GPGGA, (const char *)value, sizeof(cat_m1_Status_Rtt_Gps.GPGGA) - 1);
    ...
    {
        strncpy((char *)cat_m1_Status_Rtt_Gps.GPGLL, (const char *)value, sizeof(cat_m1_Status_Rtt_Gps.GPGLL) - 1);
    ...
    {
        strncpy((char *)cat_m1_Status_Rtt_Gps.GPGSA, (const char *)value, sizeof(cat_m1_Status_Rtt_Gps.GPGSA) - 1);
    ...
    {
        strncpy((char *)cat_m1_Status_Rtt_Gps.GPGSV, (const char *)value, sizeof(cat_m1_Status_Rtt_Gps.GPGSV) - 1);
    ...
    {
        strncpy((char *)cat_m1_Status_Rtt_Gps.GPRMC, (const char *)value, sizeof(cat_m1_Status_Rtt_Gps.GPRMC) - 1);
...
{
    strncpy((char *)cat_m1_Status_Rtt_Gps.data, (const char *)value, sizeof(cat_m1_Status_Rtt_Gps.data) - 1);
    cat_m1_Status_Rtt_Gps.data[sizeof(cat_m1_Status_Rtt_Gps.data) - 1] = '\0';
