...
CPP_SRCS += \
../Drivers/WiFi_BLE/NORA-W10.cpp 

OBJS += \
./Drivers/WiFi_BLE/NORA-W10.o 

CPP_DEPS += \
./Drivers/WiFi_BLE/NORA-W10.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/WiFi_BLE/%.o Drivers/WiFi_BLE/%.su Drivers/WiFi_BLE/%.cyclo: ../Drivers/WiFi_BLE/%.cpp Drivers/WiFi_BLE/subdir.mk
...
clean: clean-Drivers-2f-WiFi_BLE

clean-Drivers-2f-WiFi_BLE:
	-$(RM) ./Drivers/WiFi_BLE/NORA-W10.cyclo ./Drivers/WiFi_BLE/NORA-W10.d ./Drivers/WiFi_BLE/NORA-W10.o ./Drivers/WiFi_BLE/NORA-W10.su

.PHONY: clean-Drivers-2f-WiFi_BLE
